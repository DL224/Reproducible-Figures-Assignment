---
title: "ReproducibleFiguresAssignmentQuestion2"
...
culmen_ancova_plot <- ggplot(
  ...
  theme_bw() +
   theme(axis.title.x = element_text(size = 8),  
        axis.title.y = element_text(size = 8)) +
  labs(x= "Culmen Length (mm)", y= "Culmen Depth (mm)", title= "An Exploratory plot of Culmen Length vs Culmen Depth for 3 species of Penguins with linear regressions", colour = "Species") + 
  scale_color_manual(values = species_colours) 
